...
function check(countryName) {
  const lowercaseCountryName = countryName.toLowerCase();

  const foundCountryName = countries.find((findCountry) => {
   return lowercaseCountryName === findCountry.name.toLowerCase();
  });
  if (foundCountryName) {
    console.log(
      `Country code of ${foundCountryName.name} is ${foundCountryName.code}`
    );
  } else {
...
// function checkCountryCode(countryName) {
//     countries.forEach((check)=>{
//         const lowercaseCountryName = countryName.toLowerCase();
//         const lowerCaseArrayCountryName = check.name.toLowerCase();

//           if(lowercaseCountryName==lowerCaseArrayCountryName){

//         console.log(`Country code of ${check.name} is ${check.code}`);
